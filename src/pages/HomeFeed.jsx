            ...
            <div className="space-y-6">
                ...
                <Card className="p-6">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h2 className="font-bold text-lg">المواضيع الرائجة</h2>
                    </div>
                    <div className="space-y-2">
                        {trendingTopics.map((topic, index) => (
                            <button
                                key={index}
                                className="w-full text-right px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition flex items-center justify-between group"
                            >
                ...
                <Card className="p-6">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h2 className="font-bold text-lg">أسئلة بحاجة لإجابة</h2>
                    </div>
                    <div className="space-y-3">
                        {topQuestions.map((question) => (
                            ...
                            >
                                ...
                                <span className="text-xs text-slate-400">{question.views} مشاهدة</span>
                            </a>
                        ))}
                    </div>
                </Card>
                ...
                <Card className="p-6 bg-gradient-to-br from-brand-primary to-accent text-white">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h3 className="font-bold">اكسب نقاط!</h3>
                    </div>
                    <p className="text-sm text-white/90 mb-4">
                        ساعد المجتمع واحصل على نقاط وشارات قيّمة
                    </p>
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                            <span>الإجابة على سؤال</span>
                            <span className="font-bold">+15 نقطة</span>
                        </div>
                        <div className="flex justify-between">
                            <span>نشر دراسة حالة</span>
                            <span className="font-bold">+50 نقطة</span>
                        </div>
                        <div className="flex justify-between">
                            <span>أفضل إجابة</span>
                            <span className="font-bold">+30 نقطة</span>
                        </div>
                    </div>
                </Card>
            </div>
