      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8 font-medium">
            <a href="#vision" className="hover:text-brand-primary transition">الرؤية</a>
            <a href="#features" className="hover:text-brand-primary transition">المميزات</a>
            <a href="#audience" className="hover:text-brand-primary transition">الجمهور</a>
          </div>
